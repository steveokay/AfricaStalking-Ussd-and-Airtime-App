...
class oauth {
    ...
    public function __construct($client_id, $client_secret, $callback_url, $login_url = 'https://test.salesforce.com', $cache_dir = '.'){
    ...
    public function get_record($field,$record,$object="Employee__c") {
      $query = "SELECT id,Name from ".$object." WHERE ".$field." = '".$record."' ";
      ...
      //$resp = $this->my_json_decode($json_response);
